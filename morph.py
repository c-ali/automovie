...
split_prompts = remove_prefixes(raw_text)
print(f"Theme: {theme}. Prompts: {raw_text}. Generating movie...")
...
for i in range(len(list_prompts) - 1):
    ...
    fp_img_part = f"tmp_part_{str(i).zfill(3)}"
    # Run latent blending
    lb.run_transition(
    ...
    # Save movie
    lb.write_movie_transition(fp_movie_part, duration_single_trans, fps=24)
    lb.write_imgs_transition(fp_img_part)
